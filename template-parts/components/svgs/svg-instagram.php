<?php
/**
 * Template part for displaying the instagram svg
 *
...
<svg class="social-icon svg-instagram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
	<radialGradient id="rg-svg-instagram" r="150%" cx="30%" cy="107%">
