...
function starter_theme_scripts() {
	...
	wp_enqueue_script( 'starter-theme-modal', get_template_directory_uri() . '/js/modal.js', array(), _S_VERSION, true );
...
// function starter_theme_current_user()
// {
// $current_user = wp_get_current_user();
// printf(__('Username: %s', 'textdomain'), esc_html($current_user->user_login)) . '<br />';
// }

// add_action('wp_footer', 'starter_theme_current_user');
